...
BEGIN
  SET @QUERY =    "SELECT 
    ...
    IF (from_month != 0 && from_month != '') THEN
       IF (to_month != 0 && to_month != '') THEN
            SET @QUERY = CONCAT(@QUERY, " AND `county` = '",C_id,"' AND `nip`.`year` = '",filter_year,"' AND `nip`.`month` BETWEEN '",from_month,"' AND '",to_month,"' ");
        ELSE
            SET @QUERY = CONCAT(@QUERY, " AND `county` = '",C_id,"' AND `nip`.`year` = '",filter_year,"' AND `nip`.`month`='",from_month,"' ");
        END IF;
    ELSE
        SET @QUERY = CONCAT(@QUERY, " AND `county` = '",C_id,"' AND `nip`.`year` = '",filter_year,"' ");
    END IF;
...
BEGIN
  SET @QUERY =    "SELECT 
    ...
    IF (from_month != 0 && from_month != '') THEN
       IF (to_month != 0 && to_month != '') THEN
            SET @QUERY = CONCAT(@QUERY, " AND `county` = '",C_id,"' AND `nmp`.`year` = '",filter_year,"' AND `nmp`.`month` BETWEEN '",from_month,"' AND '",to_month,"' ");
        ELSE
            SET @QUERY = CONCAT(@QUERY, " AND `county` = '",C_id,"' AND `nmp`.`year` = '",filter_year,"' AND `nmp`.`month`='",from_month,"' ");
        END IF;
    ELSE
        SET @QUERY = CONCAT(@QUERY, " AND `county` = '",C_id,"' AND `nmp`.`year` = '",filter_year,"' ");
    END IF;
...
BEGIN
  SET @QUERY =    "SELECT
    ...
    IF (from_month != 0 && from_month != '') THEN
        IF (to_month != 0 && to_month != '') THEN
            SET @QUERY = CONCAT(@QUERY, " AND `cs`.`year` = '",filter_year,"' AND `cs`.`month` BETWEEN '",from_month,"' AND '",to_month,"' ");
        ELSE
            SET @QUERY = CONCAT(@QUERY, " AND `cs`.`year` = '",filter_year,"' AND `cs`.`month`='",from_month,"' ");
        END IF;
    ELSE
...
BEGIN
  SET @QUERY =    "SELECT 
    ...
    ELSE
        SET @QUERY = CONCAT(@QUERY, " AND `view_facilitys`.`county` = '",C_id,"' AND `year` = '",filter_year,"' ");
    END IF;
...
BEGIN
  SET @QUERY =    "SELECT 
    ...
    IF (from_month != 0 && from_month != '') THEN
        IF (to_month != 0 && to_month != '') THEN
            SET @QUERY = CONCAT(@QUERY, " AND `c`.`ID` = '",C_id,"' AND `year` = '",filter_year,"' AND `month` BETWEEN '",from_month,"' AND '",to_month,"' ");
        ELSE
            SET @QUERY = CONCAT(@QUERY, " AND `c`.`ID` = '",C_id,"' AND `year` = '",filter_year,"' AND `month`='",from_month,"' ");
        END IF;
    ELSE
...
BEGIN
  SET @QUERY =    "SELECT 
    ...
    IF (from_month != 0 && from_month != '') THEN
        IF (to_month != 0 && to_month != '') THEN
            SET @QUERY = CONCAT(@QUERY, " AND `nmp`.`year` = '",filter_year,"' AND `nmp`.`month` BETWEEN '",from_month,"' AND '",to_month,"' ");
        ELSE
            SET @QUERY = CONCAT(@QUERY, " AND `nmp`.`year` = '",filter_year,"' AND `nmp`.`month`='",from_month,"' ");
        END IF;
    ELSE
...
BEGIN
  SET @QUERY =    "SELECT 
    ...
    END IF;
     ...
     EXECUTE stmt;
END //
DELIMITER ; DROP PROCEDURE IF EXISTS `proc_get_eid_subcounty_hei_follow_up`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `proc_get_eid_subcounty_age`;
DELIMITER //DROP PROCEDURE IF EXISTS `proc_get_eid_subcounty_outcomes`;
DELIMITER //
...
BEGIN
  SET @QUERY =    "SELECT
    ...
    SET @QUERY = CONCAT(@QUERY, " GROUP BY `scs`.`subcounty` ORDER BY `negative` DESC ");
     ...
     EXECUTE stmt;
END //
DELIMITER ;   DROP PROCEDURE IF EXISTS `proc_get_eid_subcounty_sites_details`;
DELIMITER //
...
BEGIN
  SET @QUERY =    "SELECT 
    ...
    IF (from_month != 0 && from_month != '') THEN
        IF (to_month != 0 && to_month != '') THEN
            SET @QUERY = CONCAT(@QUERY, " AND `view_facilitys`.`district` = '",SC_id,"' AND `year` = '",filter_year,"' AND `month` BETWEEN '",from_month,"' AND '",to_month,"' ");
        ELSE
            SET @QUERY = CONCAT(@QUERY, " AND `view_facilitys`.`district` = '",SC_id,"' AND `year` = '",filter_year,"' AND `month`='",from_month,"' ");
        END IF;
    ELSE
        SET @QUERY = CONCAT(@QUERY, " AND `view_facilitys`.`district` = '",SC_id,"' AND `year` = '",filter_year,"' ");
    END IF;
    ...
    SET @QUERY = CONCAT(@QUERY, " GROUP BY `view_facilitys`.`ID` ORDER BY `tests` DESC ");
     ...
     EXECUTE stmt;
END //
DELIMITER ;  DROP PROCEDURE IF EXISTS `proc_get_eid_top_subcounty_outcomes`;
DELIMITER //
